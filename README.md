...
# R2D13 - 5/3/2018
Oh boy... I fell off the wagon... again! No worries, I am back on. I started a new job and I have allowed myself to slack in the evening because I've been learning a lot at work. But I am committed to being a great dev and I will continue on my journey of learning off the job, starting tonight. Tonight, i took a nice stroll down fundamental avenute by watching a video on the principles of object oriented programming. A lot of review, but a lot of new knowledge as well. This will be the direction of my studies for the next few weeks as I get to code at work now and I think the best thing for me as a dev outside of work is to focus on the principles and design patterns that make great software.

# R2D14 - 5/4/2018
Tonight I learned about "The Strategy Pattern". The pattern is built around the design principle of "Composition over Design". In a basic overview, the pattern is implemented by using interfaces to create a "has a" relationship with the super class. The super class can then have attributes in which it implements from the interfaces - these are private to the super class. The super class DOES provide public set methods that allow the subclasses to implement the desired behavior of the interfaces provided by the super. That was pure vomit writing but I took great hand written notes!
